...
namespace TestMovieSite
{
    public class Startup
    {
        ...
        {
            var connectionString = Configuration.GetConnectionString("AttachConnection"); // DefaultConnection
            ...
            var logger = serviceProvider.GetService<ILogger<LocalStorage>>();
            var optionsBuilder = new DbContextOptionsBuilder<ApplicationDbContext>();
            optionsBuilder.UseSqlServer(connectionString);
            services.AddSingleton(new StorageFactory(optionsBuilder.Options, logger));
